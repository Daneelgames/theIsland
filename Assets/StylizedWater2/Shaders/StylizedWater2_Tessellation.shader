...
Shader "Universal Render Pipeline/FX/Stylized Water 2 (Tessellation)"
{
	Properties
	{
		//[Header(Rendering)]
	...
	SubShader
	{
		...
		{	
			...
			#undef _DISABLE_DEPTH_TEX //Required
			#endif
...
//			#pragma multi_compile AHF_NOISEMODE_OFF AHF_NOISEMODE_PROCEDURAL3D
		...
		//Used solely in underwater rendering
		Pass
        {
            Name "DepthOnly"
...
Fallback "Universal Render Pipeline/FX/Stylized Water 2"
}
