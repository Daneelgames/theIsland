...
namespace StylizedWater2
{
    class UnderwaterPost : ScriptableRenderPass
    {
        ...
        private const string DistortionSSKeyword = "SCREENSPACE_DISTORTION";
        private const string DistortionWSKeyword = "CAMERASPACE_DISTORTION";
        ...
        public void ConfigurePass(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
        {
            ...
            mainTexRT = new RenderTargetHandle();
