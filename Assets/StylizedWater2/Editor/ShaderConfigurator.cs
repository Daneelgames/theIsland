    ...
    public class ShaderConfigurator
    {
        ...
        public static void ConfigureEnviroFog()
        {
            ...
            EditorUtility.DisplayProgressBar("Stylized Water 2", "Modifying shader...", 1f);
            {
                ...
                if(libraryFilePath == string.Empty) Debug.LogError("Fog shader library could not be found with GUID " + ENVIRO_LIBRARY_GUID);
                SetIncludePath(FogLibraryFilePath, "Enviro", libraryFilePath);
            }
            EditorUtility.ClearProgressBar();
        ...
        public static void ConfigureAzureFog()
        {
            ...
            EditorUtility.DisplayProgressBar("Stylized Water 2", "Modifying shader...", 1f);
            {
                ...
                if(libraryFilePath == string.Empty) Debug.LogError("Fog shader library could not be found with GUID " + AZURE_LIBRARY_GUID);
                SetIncludePath(FogLibraryFilePath, "Azure", libraryFilePath);
            }
            EditorUtility.ClearProgressBar();
        ...
        public static void ConfigureAtmosphericHeightFog()
        {
            ...
            EditorUtility.DisplayProgressBar("Stylized Water 2", "Modifying shader...", 1f);
            {
                ...
                if(libraryFilePath == string.Empty) Debug.LogError("Fog shader library could not be found with GUID " + AHF_LIBRARY_GUID);
                SetIncludePath(FogLibraryFilePath, "AtmosphericHeightFog", libraryFilePath);
        ...
        public static void ConfigureSCPEFog()
        {
            ...
            EditorUtility.DisplayProgressBar("Stylized Water 2", "Modifying shader...", 1f);
            {
                ...
                if(libraryFilePath == string.Empty) Debug.LogError("Fog shader library could not be found with GUID " + SCPE_LIBRARY_GUID);
