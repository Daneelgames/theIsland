...
public class RangedWeaponController : MonoBehaviour
{
    ...
    private Coroutine сontrolCoroutine;
    ...
    public void UseWeaponInput(ShipController _ship)
    {
        if (_ship != null)
        {
            ...
            if (сontrolCoroutine != null)
                StopCoroutine(сontrolCoroutine);
                
            сontrolCoroutine = StartCoroutine(СontrolCoroutine());
