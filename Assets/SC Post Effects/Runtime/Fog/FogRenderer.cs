    ...
    public class FogRenderer : ScriptableRendererFeature
    {
        ...
        class FogRenderPass : PostEffectRenderer<Fog>
        {
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                Material.SetMatrix("clipToWorld", ClipToWorldMatrix(renderingData.cameraData.camera));
        ...
        public class SkyboxTextureRenderPass : ScriptableRenderPass
        {
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                //Still used for Shader Graph node
                cmd.SetGlobalTexture("_SkyboxTex", skyboxTex);
